    ...
    <div className="flex md:flex-row flex-col py-4 mt-[2rem] md:mt-[3rem] gap-6">
      <div className="md:w-[50%] w-full flex flex-col justify-center gap-y-7">
        ...
        <div className="flex items-center sm:gap-5 gap-3">
          <button className="bg-gradient-to-r from-[#3B4EF4] via-[#5868F8] to-[#978FFD] shadow-[2px_7px_16px_0px_rgba(19,35,55,0.1)] rounded-[7px] md:px-[30px] px-[20px] md:py-[12px] py-[10px] text-[#FFFFFF] font-HelveticaNeueMedium md:text-[16px] text-[14px] ">
            Sign up free
          </button>
