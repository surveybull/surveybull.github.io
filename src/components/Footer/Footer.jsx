...
const Section = ({ title, links }) => {
    return (
        <div className="text-center lg:text-start w-max">
            <p className="sm:text-[16px] text-[14px] font-HelveticaNeueMedium text-[#132337]">{title}</p>
            <nav className="mt-4">
    ...
    return (
        <footer class="text-black" >
            <div className='bg-gradient-to-r from-[#3B4EF4] via-[#5868F8] to-[#978FFD] py-7 md:py-10 px-6 relative top-[6.5rem] w-[85vw] max-w-[1100px] mx-auto rounded-[6px] flex flex-wrap justify-center md:justify-between items-center gap-y-4 gap-x-1 shadow-[0px_4px_34px_0px_rgba(90,106,248,0.4)]'>
              <div className="text-[#FFFFFF] text-[24px] font-HelveticaNeueBold text-center">Start Earning Rewards Or Get Insightful Data ?</div>
