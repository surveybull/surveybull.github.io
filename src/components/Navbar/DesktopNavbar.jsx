...
function DesktopNavbar({NavbarData,visitedPage}) {
  return (
    <div className='flex items-center justify-between xl:max-w-[1300px] mx-auto w-full px-7 py-4'>
       ...
       <div>
        <button className='bg-gradient-to-r from-[#3B4EF4] via-[#5868F8] to-[#978FFD] shadow-[2px_7px_16px_0px_rgba(19,35,55,0.1)] rounded-[7px] px-[30px] py-[12px] text-[#FFFFFF] font-[500] text-[16px] '>Get Started</button>
       </div>
    </div>
  )
}
