  ...
  return (
    <div className="py-4 mt-[2rem] md:mt-[2rem] bg-[#132337] text-white rounded-2xl">
      ...
      <div className="m-4 flex justify-center">
        <div className="text-center md:text-base text-xs text-[#B8BDC3] max-w-[650px]">
      ...
      <div className="m-6 flex justify-center">
        <input
          className="px-2 p-2 max-w-[440px] w-full text-black text-sm rounded-lg placeholder:text-[#89919B] md:placeholder:text-base placeholder:text-sm placeholder:text-wrap"
