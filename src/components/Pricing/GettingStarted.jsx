  ...
  return (
    <div className="py-4 bg-[#132337] text-white rounded-2xl">
      <div className="m-5 text-center text-2xl md:text-4xl font-HelveticaNeueBold">
        Get Started <span className="gradient-text inline-block"> Today</span>
      </div>
      ...
      <div className="m-6 flex justify-center">
        ...
        />
        <button className="ml-4 text-sm md:text-base gradient-bg shadow-[2px_7px_16px_0px_rgba(19,35,55,0.1)] rounded-[7px] px-7 py-2 text-[#FFFFFF] font-HelveticaNeueMedium text-[16px]">
          Get Started
        </button>
      </div>
    </div>
