  ...
  return (
    <div className="py-4 mt-[2rem] md:mt-[2rem] bg-[#132337] text-white rounded-2xl">
      ...
      <div className="m-6 flex justify-center">
        ...
        />
        <button className="ml-4 text-base   bg-gradient-to-r from-[#3B4EF4] via-[#5868F8] to-[#978FFD] shadow-[2px_7px_16px_0px_rgba(19,35,55,0.1)] rounded-[7px] px-7 py-2 text-[#FFFFFF] font-HelveticaNeueMedium text-[16px]">
          Get Started
        </button>
      </div>
    </div>
