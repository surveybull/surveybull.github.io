  ...
  return (
    <div className="py-4 bg-[#132337] text-white rounded-2xl">
      ...
      <div className="m-6 flex justify-center">
        <input
          className="px-2 p-2 max-w-[440px] w-full text-black text-sm rounded-lg placeholder:text-[#89919B] md:placeholder:text-base placeholder:text-sm placeholder:text-wrap outline-none right-0 border-none"
