...
function Switcher() {
    ...
    return (
      <div className=" flex flex-col gap-y-3 mt-5">
        <span className='text-[#132337] text-[18px]'>Additional Attribute Cost</span>
        <div className="flex justify-between flex-wrap md:flex-nowrap gap-x-2 gap-y-4">
          {PossibleSwitch.map((item) => (
            <div className="flex items-center gap-2">
              ...
              <label className={`flex items-center relative w-max select-none rounded-full ${sliderValue>25 ? "cursor-pointer" : "cursor-not-allowed"}`}>
                <input
