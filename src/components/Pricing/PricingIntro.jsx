const PricingIntro = () => {
  return (
    <div className="py-4 mt-[2rem] md:mt-[3rem]">
      ...
      Welcome to our blockchain-based survey platform! You'll find a detailed breakdown of how our flexible and transparent pricing model works. Use our interactive calculator to estimate the total cost based on your specific choices and preferences. You can seamlessly pay with ETH and BULL tokens, making it easy to manage your survey expenses.
      </div>
    </div>
  );
};
