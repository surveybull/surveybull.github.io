...
const data = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "As a token staker, you become eligible to earn a share of rewards reserved specifically for participants who stake their tokens. The more tokens you stake, the greater your potential rewards.",
      },
      {
        title: "Participate in Governance ",
        text: "Stakers may also have the opportunity to participate in governance decisions, helping shape the future direction of the platform.",
      },
    ],
    reverse: false,
  },
  {
    ...
    subTitle:
      "Invite others to join the SurveyBull community and reap the rewards through our referral program. Here's how you can benefit:",
    sections: [
      {
        title: "Expand the Community",
        text: "Encourage your friends, colleagues, and network to join SurveyBull and contribute to our vibrant community of participants.",
      },
      {
        title: "Earn Rewards",
      ...
      },
      {
        ...
        text: "By actively promoting SurveyBull and sharing your positive experiences, you'll play a pivotal role in expanding our network and fostering community growth.",
      },
    ],
    reverse: true,
  },
...
const Hooks = () => {
  ...
  const ContentComponent = ({
    ...
    <div
      className={
        reverse
          ? "flex flex-row-reverse justify-between py-[20px]"
          : "flex flex-row justify-between py-[80px]"
      }
    >
  ...
  return (
    <div className="my-[4rem]">
      ...
      <div className="flex justify-center">
        <div
          data-aos={"fade-up"}
          className="mt-10  px-2 text-center max-w-[1000px] flex justify-center font-medium tracking-wide text-[#263238]"
        >
          Unlock additional avenues to boost your rewards beyond survey
          participation through SurveyBull's innovative staking and referral
          programs. Explore these opportunities to maximize your earnings and
