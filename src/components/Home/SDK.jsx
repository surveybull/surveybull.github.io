...
const SDK = () => {
  return (
    <div className="flex flex-col gap-y-12 py-[80px]">
      <div className="flex flex-col gap-y-7">
        <span className="text-center md:text-[36px] text-[24px] font-HelveticaNeueBold text-[#132337]"><span className="text-[#3B4EF4]">Software</span> Development Kit (SDK) for Seamless <span className="text-[#3B4EF4]">Survey Integration</span></span>
      ...
      <div className="flex lg:flex-row flex-col-reverse gap-7 justify-center items-center">
        <div className="flex flex-col gap-y-5 flex-1 justify-evenly">
          <div className="flex flex-col gap-y-3">
            <span className="md:text-[20px] text-[18px] font-HelveticaNeueMedium text-[#3B4EF4]">Streamlined Integration</span>
          ...
          <div className="flex flex-col gap-y-3">
            <span className="md:text-[20px] text-[18px] font-HelveticaNeueMedium text-[#3B4EF4]">Expanding Accessibility</span>
            <span className="md:text-[16px] text-[14px] font-[400] text-[#5A6573]">
