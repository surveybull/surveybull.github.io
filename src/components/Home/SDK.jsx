  ...
  return (
    <div className="flex flex-col gap-y-10 ">
      <div className="flex flex-col gap-y-7">
        <h3 className="text-center md:text-[36px] md:leading-[52px] text-[24px] leading-[40px] font-HelveticaNeueBold text-[#132337] max-w-[800px] mx-auto">
      ...
      <div className="flex lg:flex-row flex-col-reverse gap-7 justify-center items-center">
        <div className="flex flex-col gap-y-5 flex-1 justify-evenly">
          <div className="flex flex-col gap-y-3">
            <h6 className="w-fit gradient-text md:text-[20px] text-[18px] font-HelveticaNeueMedium ">
        ...
        <div className="flex-1">
          <img src={SDKSnippet} alt="SDKSnippet" className="max-h-[450px]" loading="lazy" />
        </div>
      </div>
    </div>
  );
