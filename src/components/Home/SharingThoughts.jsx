...
const Card = ({ src, alt, text, description, delay }) => (
  ...
  >
    ...
    <div className={descriptionClass} style={{ color: "#4E55FF" }}>
      Learn more
    </div>
  </div>
);
...
const dialogData = [
  {
    trigger: (
      <Card
        ...
        description={
          "Participate in surveys on SurveyBull to earn tokens for your time and effort."
        }
        delay={"500"}
      />
    ),
  ...
  },
  {
    trigger: (
      <Card
        ...
        description={
          "Our reward system, built on smart contracts, securely holds tokens until distribution to participants."
        }
        data={"700"}
      />
    ),
  ...
  },
  {
    trigger: (
      <Card
        ...
        description={
          "After a survey closes, participants are alerted on the SurveyBull platform about available rewards."
        }
        delay={"900"}
      />
    ),
  ...
  return (
    <div className=" my-[4rem] xl:my-[4rem]">
      ...
      <div className="flex justify-center">
        <div
          data-aos={"fade-up"}
          className="mt-10 text-center max-w-[1000px] px-2 flex justify-center font-medium tracking-wide text-[#263238]"
        >
