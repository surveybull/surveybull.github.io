...
const Intro = () => {
  return (
    <div className="flex justify-center mt-[3rem] lg:mt-[7rem] mb-[3rem] gap-6 flex-col md:flex-row">
      <div className="flex flex-col gap-y-[1.5rem] lg:gap-y-8 justify-center md:items-center items-start flex-1">
        <AnimatedText />
        ...
        <div>
          <button
            className="mainnet-button gradient-bg shadow-[2px_7px_16px_0px_rgba(19,35,55,0.1)] rounded-[7px] sm:px-[30px] sm:py-[12px] px-[20px] py-[10px] text-[#FFFFFF] sm:font-HelveticaNeueMedium sm:text-[16px] text-[14px] font-[400]"
            onClick={() => {
