        ...
        <div className="w-full bg-transparent p-4 lg:p-8 bg-[#FFFFFF] border border-[#E7E9EB] rounded-[22.94px] shadow-[2px_7px_25px_0px_rgba(151,143,253,0.14)]">
          <div className="flex max-lg:flex-col gap-8 w-full">
              ...
              <div className="relative">
                <div
                  className={`
                      ...
                      before:content-[''] before:absolute before:bg-[#978FFD]
                      ...
                      max-lg:before:h-0.5 max-lg:before:w-auto max-lg:before:bottom-auto max-sm:before:top-[18px]
                  `}
                >
                  {content.map((step) => {
                      ...
                      >
                        <div
                          className={`w-8 h-8 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-colors ${isActive
                            ? "bg-white border-2 sm:border-4 border-[#3B4EF4] text-[#3B4EF4]"
                            : "bg-gray-200 text-gray-500 border border-[#3B4EF4]/20"
                            }`}
                        >
                          <Icon className="w-3 h-3 sm:w-5 sm:h-5" />
                        </div>
                        <div className="flex flex-col justify-center items-center lg:items-start">
                          <div className={`text-xs sm:text-sm text-center ${isActive ? "text-[#3B4EF4]" : "text-gray-500"}`}>
                            Step {step.id}
                          </div>
            ...
            <div className="flex-1 bg-[#EDEFFF] p-8 rounded-[10px] max-w-[960px] min-h-[400px]">
              <div className="text-[#3B4EF4] text-sm sm:text-lg font-medium mb-2">Step {content[activeStep - 1].id}</div>
              ...
              <div className="w-full">
                <div className="w-full">
                  ...
                  <p className="text-gray-600 text-[14px] md:text-base ">{content[activeStep - 1].data.desc2}</p>
                </div>
                <div className="w-full">
                  <img
